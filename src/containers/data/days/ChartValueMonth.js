...
const covidUrl2 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${
  result < 10 ? date[1] - 1 : date[1]
}&endCreateDt=${result < 10 ? date[1] - 1 : date[1]}`;
const covidUrl3 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${
  result < 10 ? date[2] - 1 : date[2]
}&endCreateDt=${result < 10 ? date[2] - 1 : date[2]}`;
const covidUrl4 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${
  result < 10 ? date[3] - 1 : date[3]
}&endCreateDt=${result < 10 ? date[3] - 1 : date[3]}`;
const covidUrl5 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${
  result < 10 ? date[4] - 1 : date[4]
}&endCreateDt=${result < 10 ? date[4] - 1 : date[4]}`;
const covidUrl6 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${
  result < 10 ? date[5] - 1 : date[5]
}&endCreateDt=${result < 10 ? date[5] - 1 : date[5]}`;
const covidUrl7 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${
  result < 10 ? date[6] - 1 : date[6]
}&endCreateDt=${result < 10 ? date[6] - 1 : date[6]}`;
const covidUrl8 = `/openapi/service/rest/Covid19/getCovid19InfStateJson?serviceKey=${API_KEY}&pageNo=1&numOfRows=10&startCreateDt=${

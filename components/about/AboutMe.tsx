...
function AboutMe() {
	return (
		<div
			id="about-me"
			className="container mx-auto my-12 flex flex-col lg:flex-row justify-evenly items-center select-none"
		>
			...
			<div className="mt-4 lg:mt-0">
				<h1 className="font-noto text-4xl font-bold mb-2">ABOUT ME</h1>
